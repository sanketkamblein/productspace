...
const projects = [
  {
    id: 1,
    title: "AR Assistant for Joule — Agentic Finance UX",
    category: "UX Design",
    description: "Designed the Engagement Layer for SAP's AI-powered AR Assistant — a multi-agent system for Accounts Receivable in SAP S/4HANA.",
    badge: "End-to-End UX Designer",
    year: "2025–26",
    image: "images/ar_assistant_thumb.png",
    details: {
      role: "End-to-End UX Designer — Private Cloud",
      context: "SAP S/4HANA + Joule + BTP | Finance / Accounts Receivable | GTM: SAP Sapphire 2026",
      duration: "1.5 years (July 2025 – Sapphire 2026)",
      team: "Cross-cloud — Private Cloud (lead) + Public Cloud Design & Dev",
      challenge: "AR Accountants and Collection Specialists spend 20+ minutes per account gathering data across 5+ screens. No unified view of overdue items, disputes, dunning history, and payment behaviour exists. Worklists are static, dispute resolution is fully manual, and payment clearing relies on manual matching — inflating DSO and burning specialist time on low-value tasks.",
      myRole: "Led UX for the AR Assistant from end-to-end — spanning customer engagement and idea pitching, user research and persona definition, user validation sessions, agent architecture and flow design, and Engagement Layer UX design for both primary personas.",
      contributions: [
        "Participated in early customer engagement to validate the Joule-powered AR use case — built customer buy-in for the concept.",
        "Defined the AR Accountant and Collection Specialist personas through interviews and workflow analysis; mapped pain points to agent capabilities.",
        "Led user validation for Worklist Prioritization, 360° account view, and Dispute Resolution flows — confirmed the action-first UX pattern.",
        "Designed the orchestration flows for the full multi-agent AR Assistant, including cross-assistant integration with the Billing Adjustment Agent.",
        "Designed Joule Engagement Layer screens for both personas — worklist, account cards, HITL confirmation patterns, and @mention flows.",
        "Defined 5 GTM flows for SAP Sapphire 2026 — the AR Assistant's flagship customer-facing demonstration.",
        "Collaborated with Private Cloud and Public Cloud engineering to ensure design integrity through delivery.",
      ],
      outcome: [
        "AR Assistant delivered at SAP TechEd 2025 (AR Agent) and extending to SAP Sapphire 2026 (full Engagement Layer).",
        "€83k annual benefit via DSO reduction (38.0 → 37.6 days) based on SAP Value Management estimates.",
        "15 minutes saved per account analysis session — from 20 min manual to 5 min AI-assisted.",
        "7+ specialized agents orchestrated in a single Joule conversation replacing 5+ screens.",
        "2 primary personas — AR Accountant and Collection Specialist — served with role-specific Engagement Layer.",
        "5 GTM flows defined for SAP Sapphire 2026 covering Worklist, 360° View, Dispute Resolution, Smart Clearing, and EL Collections.",
      ],
      toolsAndSkills: [
        "Figma, Figma Make, Claude, Cursor / Cline, Make (no-code automation)",
        "Joule UX Patterns, Engagement Layer Design, Agent Interaction Design",
        "User Research, Persona Definition, UX Validation, Flow Design",
        "SAP Fiori, SAP S/4HANA FI-AR, Dispute Management, Collections Management",
        "Cross-cloud collaboration, GTM Strategy, Customer Engagement",
      ],
      links: [
        {
          title: "Explore full case study →",
          url: "projects/AR Assistant/portfolio.html",
        },
      ],
    },
  },
